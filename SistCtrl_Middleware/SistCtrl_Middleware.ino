...
// ############################===########################## KEVIN E PEDRO
int Pinotemperature = 0; //LDR no pino analógico 8
int temperature = 0; //Valor lido do Pinotemperature
char aquariumCicle[] = "MAXIMUM";

byte mac[] = {
  0xDE, 0xAD, 0xBE, 0xEF, 0xFE, 0xED };
IPAddress ip(169,254,202,145);          //Definir o endereco IP
IPAddress gateway(192,168,0,1);         //Definir o gateway
IPAddress subnet(255,255,0,0);          //Definir a máscara de rede
 
//Inicializa o servidor web na porta 80 se for www.
...
void setup()
{
  ...
  // ler o valor do tempearuta
  temperature = tempAtual;
  // ler o valor do filtro 
  aquariumCicle = filtroAtual; /
    ...
    while (client.connected()) {
      if (client.available()) {
        ...
        if (c == 'n' && currentLineIsBlank) {
          ...
          //Mostra as informacoes lidas pelo sensor de temperatura e filtro
          //JASON example: "temperature":22.6,"aquariumCicle":"ON"}
